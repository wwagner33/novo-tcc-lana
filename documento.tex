...
%Solucao do problema de warnings de glossaries
...
\iessigla{UFC}
\centro{Instituto Universidade Virtual}
...
\graduacaoem{Sistemas e Mídias Digitais - Noturno}
...
\autor{Alana Campelo Vasconcelos}
\titulo{Estudo de caso sobre o desenvolvimento de software para Gestão de qualidade em indústrias automobilísticas com enfoque em Design Centrado no Usuário e Metodologias de Prototipagem Digital}
\data{2023}
\local{Fortaleza}

% Exemplo: \dataaprovacao{01 de Janeiro de 2012}
\dataaprovacao{16 de Dezembro de 2023}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%           Informação sobre o Orientador         %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\orientador{Prof. Me. Wellington Wagner Ferreira Sarmento}
\orientadories{Universidade Federal do Ceará (UFC)}
\orientadorcentro{Instituto Universidade Virtual}
...
\membrodabancadois{Prof. Dr. Antônio José Melo Leite Júnior}
\membrodabancadoiscentro{Instituto Universidade Virtual}
\membrodabancadoisies{Universidade Federal do Ceará (UFC)}
\membrodabancatres{Prof. Dr. Leonardo Oliveira Moreira}
\membrodabancatrescentro{Instituto Universidade Virtual}
